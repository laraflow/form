                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gNumber('money', 'Money', 100.00, true, 'fab fa-draft2digital',
                                            'before',
                                            ['step' =>"0.01", 'min'=> 0])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gSearch('search_text', 'Search Text', null, false, 'fas fa-search',
                                            'before',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gSelect('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'], 2,
                                            false, 'fas
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gSelect('animal', 'Animal', [ 'Cats' => ['leopard' => 'Leopard'],
                                            'Dogs' =>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gSelectMulti('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'],
                                            [2,1] ,
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gSelectMonth('month', 'Month', '2', true, 'far fa-calendar-alt',
                                            'before',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gText('summary', 'Summary', 'short summary', true, 'fas fa-font',
                                            'before',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::gTextarea('description', 'Description', 'short description', true,
                                            'fas
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hCheckbox('item', 'Item(s)', [1=>'Egg', 2 => 'Rice', 3 => 'other'],
                                            [3, 2],
                                            true)
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hNumber('money', 'Money', 100.00, true, 2, ['step' =>"0.01", 'min'=>
                                            0])
                                        </code>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hRadio('gender', 'Gender', [1=>'Male', 2 => 'Female', 3 => 'Other'],
                                            3, true,
                                            2)
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSearch('search_text', 'Search Text', null, false, 2, ['placeholder'
                                            =>
                                            "Enter
                                            what you want..."])
                                        </code>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelect('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'], 2,
                                            false, 2,
                                            ['placeholder' => "Select a State"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelect('animal', 'Animal', [ 'Cats' => ['leopard' => 'Leopard'],
                                            'Dogs' =>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelectMulti('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'],
                                            [2,1] ,
                                            false, 2, [])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelectMonth('month', 'Month', '2', true, 2, ['placeholder' =>
                                            "Select a
                                            Month"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelectRange('rating', 'Rating', 1,100, 20, false, 2, ['placeholder'
                                            =>
                                            "Select
                                            a Rating"])
                                        </code>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hTel('mobile', 'Mobile', null, true, 2, ['placeholder' => "Enter
                                            Mobile
                                            Number"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hText('summary', 'Summary', 'short summary', true, 2, ['placeholder'
                                            => "Type
                                            some summary"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hTextarea('description', 'Description', 'short description', true,
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hUrl('website', 'Website', null, true, 2, ['placeholder' => "Enter
                                            Your
                                            Portfolio link"])
                                        </code>
                                    </td>
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iCheckbox('item', 'Item(s)', [1=>'Egg', 2 => 'Rice', 3 => 'other'],
                                            [3, 2],
                                            true)
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iNumber('money', 'Money', 100.00, true, 'fas fa-user', 'before',
                                            ['step' =>"0.01", 'min'=> 0])
                                        </code>
                                    </td>
                                    <td>
                                        {!! \Form::iNumber('money', 'Money', 100.0, true, 'fas fa-user', 'before', ['step' => '0.01', 'min' => 0]) !!}
                                    </td>
                                </tr>
                                <tr>
                                    <th>8.</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iRadio('gender', 'Gender', [1=>'Male', 2 => 'Female', 3 => 'Other'],
                                            3, true)
                                        </code>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iSearch('search_text', 'Search Text', null, false, 'fas fa-user',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iSelect('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'], 2,
                                            false,
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iSelect('animal', 'Animal', [ 'Cats' => ['leopard' => 'Leopard'],
                                            'Dogs' =>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iSelectMulti('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'],
                                            [2,1] ,
                                            false, [])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iSelectRange('rating', 'Rating', 1,100, 20, false, 'fas fa-user',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iTel('mobile', 'Mobile', null, true, 'fas fa-user',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iText('summary', 'Summary', 'short summary', true, 'fas fa-user',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::iUrl('website', 'Website', null, true, 'fas fa-user',
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nCheckbox('item', 'Item(s)', [1=>'Egg', 2 => 'Rice', 3 => 'other'],
                                            [3, 2],
                                            true)
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nRadio('gender', 'Gender', [1=>'Male', 2 => 'Female', 3 => 'Other'],
                                            3, true)
                                        </code>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nSearch('search_text', 'Search Text', null, false, ['placeholder' =>
                                            "Enter
                                            what you want..."])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nSelect('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'], 2,
                                            false,
                                            ['placeholder' => "Select a State"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nSelect('animal', 'Animal', [ 'Cats' => ['leopard' => 'Leopard'],
                                            'Dogs' =>
                                            ['spaniel' => 'Spaniel']], 2, false, ['placeholder' => "Select a Animal"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nSelectMulti('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'],
                                            [2,1] ,
                                            false, [])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nSelectRange('rating', 'Rating', 1,100, 20, false, ['placeholder' =>
                                            "Select
                                            a Rating"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::nText('summary', 'Summary', 'short summary', true, ['placeholder' =>
                                            "Type
                                            some summary"])
                                        </code>
                                    </td>
