            ...
            <div class="col-12">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-link active" id="nav-address-tab" data-toggle="tab" href="#nav-address"
                            role="tab" aria-controls="nav-address" aria-selected="true">
                            Normal
                        </a>
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hCheckbox('item', 'Item(s)', [1=>'Egg', 2 =>
                                            'Rice', 3 => 'other'],
                                            [3, 2],
                                            true)
                                        </code>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hDate('meeting_date', 'Meeting Date', null,
                                            true)
                                        </code>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hEmail('email_address', 'Email Address',
                                            'john@doe.com', true, 2,
                                            ['placeholder' =>"Email Example Placeholder"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hFile('import_file', 'Import File', true, 2,
                                            ['accept' => "audio/*"])
                                        </code>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hImage('photo', 'Photo', true, 2, ['preview' => false, 'height' =>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hNumber('money', 'Money', 100.00, true, 2,
                                            ['step' =>"0.01", 'min'=>
                                            0])
                                        </code>
                                    </td>
                                    <td>
                                        {!! \Form::hNumber('money', 'Money', 100.0, true, 2, ['step' => '0.01', 'min' => 0]) !!}
                                    </td>
                                </tr>
                                <tr>
                                    <th>8.</th>
                                    <td>
                                        <code class="d-block">
                                            \Form::hPassword('password', 'Password', true, 2,
                                            ['placeholder'
                                            =>"Password Placeholder"])
                                        </code>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hRadio('gender', 'Gender', [1=>'Male', 2 =>
                                            'Female', 3 => 'Other'],
                                            3, true,
                                            2)
                                        </code>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hRange('rating', 'Rating', 5, true, 2, ['min'
                                            => 0, 'max' => 100])
                                        </code>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSearch('search_text', 'Search Text', null,
                                            false, 2, ['placeholder'
                                            =>
                                            "Enter
                                            what you want..."])
                                    ...
                                    <td>
                                        {!! \Form::hSearch('search_text', 'Search Text', null, false, 2, [
                                            'placeholder' => 'Enter what you want...',
                                        ]) !!}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelect('state', 'State', [1 => 'Dhaka', 2 =>
                                            'Chittagong'], 2,
                                            false, 2,
                                            ['placeholder' => "Select a State"])
                                        </code>
                                    ...
                                    <td>
                                        {!! \Form::hSelect('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'], null, false, 2, [
                                            'placeholder' => 'Select a State',
                                        ]) !!}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelect('animal', 'Animal', [ 'Cats' =>
                                            ['leopard' => 'Leopard'],
                                            'Dogs' =>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelectMulti('state', 'State', [1 => 'Dhaka',
                                            2 => 'Chittagong'],
                                            [2,1] ,
                                            false, 2, [])
                                        </code>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelectMonth('month', 'Month', '2', true, 2,
                                            ['placeholder' =>
                                            "Select a
                                            Month"])
                                        </code>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hSelectRange('rating', 'Rating', 1,100, 20,
                                            false, 2, ['placeholder'
                                            =>
                                            "Select
                                            a Rating"])
                                    ...
                                    <td>
                                        {!! \Form::hSelectRange('rating', 'Rating', 1, 100, 20, false, 2, [
                                            'placeholder' => 'Select a Rating',
                                        ]) !!}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hTel('mobile', 'Mobile', null, true, 2,
                                            ['placeholder' => "Enter
                                            Mobile
                                            Number"])
                                        </code>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hText('summary', 'Summary', 'short summary',
                                            true, 2, ['placeholder'
                                            => "Type
                                            some summary"])
                                        </code>
                                    ...
                                    <td>
                                        {!! \Form::hText('summary', 'Summary', 'short summary', true, 2, [
                                            'placeholder' => 'Type some summary',
                                        ]) !!}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hTextarea('description', 'Description',
                                            'short description', true,
                                            2, ['placeholder' => "Type some description"])
                                        </code>
                                    </td>
                                    <td>
                                        {!! \Form::hTextarea('description', 'Description', 'short description', true, 2, [
                                            'placeholder' => 'Type some description',
                                        ]) !!}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <code class="d-block">
                                            \Form::hUrl('website', 'Website', null, true, 2,
                                            ['placeholder' => "Enter
                                            Your
                                            Portfolio link"])
                                        </code>
                    ...
                    <div class="tab-pane fade" id="nav-directive" role="tabpanel"
                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_checkbox('item', 'Item(s)', [1=>'Egg', 2 =>
                                        'Rice', 3 => 'other'],
                                        [3, 2],
                                        true)
                                    </code>
                                ...
                                <td>
                                    @form_checkbox('item', 'Item(s)', [1 => 'Egg', 2 => 'Rice', 3 => 'Unknown'], [3, 2], true)
                                </td>
                            </tr>
                            <tr>
                                <th>2.</th>
                                <td>
                                    <code class="d-block">
                                        @form_date('meeting_date', 'Meeting Date', null,
                                        true)
                                    </code>
                                </td>
                                <td>
                                    @form_date('meeting_date', 'Meeting Date', null, true)
                                </td>
                            </tr>
                            <tr>
                                <th>3.</th>
                                <td>
                                    <code class="d-block">
                                        @form_email('email_address', 'Email Address',
                                        'john@doe.com', true,
                                        ['placeholder'
                                        =>"Email Example Placeholder"])
                                    </code>
                                ...
                                <td>
                                    {!! @form_email('email_address', 'Email Address', 'john@doe.com', true, [
                                        'placeholder' => 'Email Example Placeholder',
                                    ]) !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_file('import_file', 'Import File', true,
                                        ['accept' => "audio/*"])
                                    </code>
                                </td>
                                <td>
                                    @form_file('import_file', 'Import File', true, ['accept' => 'audio/*'])
                                </td>
                            </tr>
                            <tr>
                                <th>5.</th>
                                <td>
                                    <code class="d-block">
                                        @form_image('photo', 'Photo', true, [], ['accept'
                                        => "image/*"])
                                    </code>
                                </td>
                                <td>
                                    @form_image('photo', 'Photo', true, ['accept' => 'image/*'])
                                </td>
                            </tr>
                            <tr>
                                <th>6.</th>
                                <td>
                                    <code class="d-block">
                                        @form_image('profile_photo', 'Profile Photo',
                                        true,
                                        ['preview' => true, 'height' => 128,
                                        'default' => 'https://via.placeholder.com/300x128.png'], ['accept' =>
                                        "image/*"])
                            ...
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_number('money', 'Money', 100.00, true,
                                        ['step' =>"0.01", 'min'=> 0])
                                    </code>
                                </td>
                                <td>
                                    @form_number('money', 'Money', 100.0, true, ['step' => '0.01', 'min' => 0])
                                </td>
                            </tr>
                            <tr>
                                <th>8.</th>
                                <td>
                                    <code class="d-block">
                                        @form_password('password', 'Password', true,
                                        ['placeholder'
                                        =>"Password Placeholder"])
                                    </code>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_radio('gender', 'Gender', [1=>'Male', 2 =>
                                        'Female', 3 => 'Other'],
                                        3, true)
                                    </code>
                                </td>
                                <td>
                                    @form_radio('gender', 'Gender', [1 => 'Male', 2 => 'Female', 3 => 'Other'], 3, true)
                                </td>
                            </tr>
                            <tr>
                                <th>10.</th>
                                <td>
                                    <code class="d-block">
                                        @form_range('rating', 'Rating', 5, true, ['min' =>
                                        0, 'max' => 100])
                                    </code>
                                </td>
                                <td>
                                    @form_range('rating', 'Rating', 5, true, ['min' => 0, 'max' => 100])
                                </td>
                            </tr>
                            <tr>
                                <th>11.</th>
                                <td>
                                    <code class="d-block">
                                        @form_search('search_text', 'Search Text', null,
                                        false, ['placeholder' =>
                                        "Enter
                                        what you want..."])
                                    </code>
                                ...
                                <td>
                                    {!! @form_search('search_text', 'Search Text', null, false, [
                                        'placeholder' => 'Enter what you want...',
                                    ]) !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_select('state', 'State', [1 => 'Dhaka', 2 =>
                                        'Chittagong'], 2,
                                        false,
                                        ['placeholder' => "Select a State"])
                                    </code>
                                ...
                                <td>
                                    {!! @form_select('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'], null, false, [
                                        'placeholder' => 'Select a State',
                                    ]) !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_select('animal', 'Animal', [ 'Cats' =>
                                        ['leopard' => 'Leopard'],
                                        'Dogs' =>
                                        ['spaniel' => 'Spaniel']], 2, false, ['placeholder' => "Select a Animal"])
                                    </code>
                            ...
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_selectmulti('state', 'State', [1 => 'Dhaka',
                                        2 => 'Chittagong'],
                                        [2,1] ,
                                        false, [])
                                    </code>
                                ...
                                <td>
                                    @form_selectmulti('state', 'State', [1 => 'Dhaka', 2 => 'Chittagong'], [2, 1], false, [])
                                </td>
                            </tr>
                            <tr>
                                <th>15.</th>
                                <td>
                                    <code class="d-block">
                                        @form_selectmonth('month', 'Month', '2', true,
                                        ['placeholder' => "Select a
                                        Month"])
                                    </code>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_selectrange('rating', 'Rating', 1,100, 20,
                                        false, ['placeholder' =>
                                        "Select
                                        a Rating"])
                                    </code>
                                ...
                                <td>
                                    {!! @form_selectrange('rating', 'Rating', 1, 100, 20, false, [
                                        'placeholder' => 'Select a Rating',
                                    ]) !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_tel('mobile', 'Mobile', null, true,
                                        ['placeholder' => "Enter Mobile
                                        Number"])
                                    </code>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_text('summary', 'Summary', 'short summary',
                                        true, ['placeholder' =>
                                        "Type
                                        some summary"])
                                    </code>
                                ...
                                <td>
                                    {!! @form_text('summary', 'Summary', 'short summary', true, [
                                        'placeholder' => 'Type some summary',
                                    ]) !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    {!! @form_textarea('description', 'Description', 'short description', true, [
                                        'placeholder' => 'Type some description',
                                    ]) !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <code class="d-block">
                                        @form_url('website', 'Website', null, true,
                                        ['placeholder' => "Enter Your
                                        Portfolio link"])
                                    </code>
                                </td>
